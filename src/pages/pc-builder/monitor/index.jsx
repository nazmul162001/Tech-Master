...
const CategoryMonitorInfo = ({ relatedProduct }) => {
...
export const getServerSideProps = async () => {
  const response = await fetch(
    'https://pc-builder-server-webdevnazmulh-gmailcom.vercel.app/api/v1/products?category=monitor'
  )
